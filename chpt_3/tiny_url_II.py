# http://www.jiuzhang.com/solution/tiny-url-ii/
# 实现一个顾客短网址，使得顾客可以创立他们自己的短网址


class TinyUrl2:
    def __init__(self):
        # id generated from long url
        self.id2url = {}
        self.url2id = {}
        # customized short -> long url
        self.custom_s2l = {}
        # long url -> customized short
        self.custom_l2s = {}
    ...
    def shortToLong(self, short_url):
        ...
        # check if short url is a saved customized one
        # if not use the regular shorturl -> longurl
            # short url -> id
